...
eval(fs.readFileSync('src/loaders/STLLoader.js') + ''); //Original
eval(fs.readFileSync('src/loaders/3MFLoader.js') + ''); //Custom
eval(fs.readFileSync('src/loaders/AMFLoader.js') + ''); //Custom
eval(fs.readFileSync('src/loaders/AWDLoader.js') + ''); //Custom
eval(fs.readFileSync('src/loaders/ColladaLoader.js') + ''); //Custom
eval(fs.readFileSync('src/loaders/CTMLoader.js') + ''); //Custom
eval(fs.readFileSync('src/loaders/PLYLoader.js') + ''); //Original
eval(fs.readFileSync('src/loaders/VTKLoader.js') + ''); //Original
...
function getThreeObjectRedy(object) {
  ...
  function convertObject(object) {
    ...
    if (box.getSize().y > maxSize) {
      maxSize = box.getSize().y;
    }
    if (box.getSize().z > maxSize) {
      maxSize = box.getSize().z;
    }
